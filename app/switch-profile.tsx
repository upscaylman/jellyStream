...
export default function SwitchProfileScreen() {
    ...
    const profiles = [
        { id: '1', name: userName || 'Utilisateur', avatar: `https://ui-avatars.com/api/?name=${encodeURIComponent(userName || 'U')}&background=E50914&color=fff&size=120` },
    ];
    ...
    const handleProfileSelect = async (_profileId: string) => {
        goBack();
    };
